...
<div class="navbar bg-base-100 shadow-md sticky top-0 z-20 px-4">
...
<main class="p-5 pb-24 mx-auto">
  <section class="form-control mb-8">
...
<nav class="fixed bottom-0 left-0 right-0 bg-base-100 border-t border-base-200 z-50 pb-safe">
  <div class="grid grid-cols-3 h-16 items-center justify-items-center">
    ...
    <a class="btn btn-ghost btn-sm flex flex-col gap-0 h-full w-full rounded-none normal-case font-medium text-base-content/50" aria-label="go to settings">
