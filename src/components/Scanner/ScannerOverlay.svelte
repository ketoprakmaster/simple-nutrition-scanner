...
<div class="relative flex h-full flex-col justify-between p-10 gap-5">
  ...
  <p class="text-white text-sm backdrop-blur-md py-2 px-6 rounded-md w-full text-center border border-white/10 z-20">
